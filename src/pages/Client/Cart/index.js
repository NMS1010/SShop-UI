                    ...
                    {cartItems.length > 0 ? (
                                ...
                                <div className="row mx-0 text-gray-300 items-center text-center">
                                    <div className="col col-1">
                                        <Checkbox
                                            onChange={onChange}
                                            checked={
                                                selectedItems.totalItem === cartItems.length && cartItems.length > 0
                                            }
                                        />
                                    </div>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center mt-2">
                                <p className="text-5xl text-gray-400">Your cart is Empty!</p>
                                <p className="text-3xl text-gray-400">Add something to make me happy !!!</p>
                            </div>
                        </div>
                    )}
                    {cartItems.length > 0 && (
